...
### Emoji表情
:smile: :flushed: :joy: :triumph: :white_flower: :sunny: <br>
<font size="10"> :smile: :flushed: :joy: :triumph: :white_flower: :sunny: </font>
```
...
<img src="{{"/cv/thumbs_up.jpg" | absolute_url}}" width="50%" alt=""/>
